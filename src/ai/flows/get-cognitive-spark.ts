  ...
  musicSuggestion: z
    .object({
      title: z
        .string()
        .describe(
          'The title of the soundscape suggestion (e.g., "Calming Rain", "Forest Ambience", "Gentle Ocean Waves"). Choose from a predefined list of natural sounds.'
        ),
      description: z
        .string()
        .describe(
...
6.  **Music Suggestion:** Based on the user's situation, suggest a natural soundscape that could help. Choose a title from ONLY the following options: "Calming Rain", "Forest Ambience", "Gentle Ocean Waves", "Crackling Fireplace", "Peaceful Night". Provide a title and a short description explaining why it's a good fit.`,
});
