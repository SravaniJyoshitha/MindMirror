...
6.  **Music Suggestion:** Based on the user's situation, suggest a natural soundscape that could help. Choose a title from the following options: "Calming Rain", "Forest Ambience", "Gentle Ocean Waves", "Crackling Fireplace", "Peaceful Night". Provide a title and a short description explaining why it's a good fit.`,
});
