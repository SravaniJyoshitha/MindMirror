...
const CognitiveSparkOutputSchema = z.object({
  ...
  musicSuggestion: z
    .object({
      title: z.string().describe('The title of the music suggestion (e.g., "432Hz Calming Frequency").'),
      description: z
        .string()
        .describe(
          'A brief description of why this music might help for the user\'s situation.'
        ),
    })
...
6.  **Music Suggestion:** Based on the user's situation, suggest a type of music, sound, or audio frequency that could help. For anxiety, you might suggest "432Hz Calming Frequency" or for sadness, "Uplifting Classical Music". Provide a title and a short description.`,
});
